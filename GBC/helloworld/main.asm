...
; ---------------------------------
_main::
;main.c:17: UINT8 index = 1;
	ld	c, #0x01
;main.c:18: set_bkg_data(0, 8, bkg_tileset);
	ld	de, #_bkg_tileset
	push	de
	ld	hl, #0x800
	push	hl
	call	_set_bkg_data
	add	sp, #4
;main.c:19: set_bkg_tiles(0, 0, 40, 18, bkg_map);
	ld	de, #_bkg_map
	push	de
	ld	hl, #0x1228
	push	hl
	...
	call	_set_bkg_tiles
	add	sp, #6
;main.c:20: set_sprite_data(0, 3, dummy_sprite);
	ld	de, #_dummy_sprite
	push	de
	ld	hl, #0x300
	push	hl
...
;main.c:35: index = 2;
	...
	jr	00109$
00105$:
;main.c:36: }else if(index == 2 && t % 4 == 0){
	ld	a, c
	sub	a, #0x02
	jr	NZ, 00109$
	ld	a, e
